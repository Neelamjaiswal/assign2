...
export default function () {
  ...
  return (
    ...
    <div style={ckd}>
    <h3 style={ckh}>Enter Experience</h3>
    <input type="text" name="Experiece" value={user.name} style ={csl} placeholder="Enter your Experience " onChange={ handleChange }  ></input> <br /><br />
