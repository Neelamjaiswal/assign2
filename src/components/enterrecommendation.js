...
export default function () {
  ...
  return (
    ...
    <div style={ckd}>
    <h3 style={ckh}>Enter Recommendations</h3>
    <input type="text" name="Skill" value={user.name} style ={csl} placeholder="Enter Recommendation " onChange={ handleChange }  ></input> <br /><br />
